    ...
    methods: {
          ...
          n = () => {
            t.setAttribute("style", "--loading-percentage: 100%"),
              gsap
                ...
                .to(t, { y: "-100%", duration: 1, ease: "expo.in" }, "-=0.5")
                .set(t, { autoAlpha: 0 });
          },
          a = () => {
            e++,
        ...
        e.length &&
          e.forEach((e) => {
            gsap
              ...
              .from(e.querySelector(".subtitle"), { autoAlpha: 0, top: 50 })
              .from(e.querySelector("h2"), { autoAlpha: 0, y: 50 }, "-=0.2")
              .from(
      ...
      animExperienceItemsTimeline() {
        ...
        t.length &&
          ((s = gsap.timeline()),
          t.forEach((e) => {
            s.from(e, { autoAlpha: 0 }).from(e, { scale: 0.2 }, "<");
          }),
          o.add(s, "< +=0.5"));
      },
  ...
  Vue.createApp({
    ...
    data: () => ({
      ...
      navLinks: [
        ...
        { url: "#skills", title: { en: "Skills", ar: "مهاراتي" } },
        { url: "#portfolio", title: { en: "Portfolio", ar: "أعمالي" } },
        { url: "#contact", title: { en: "Contact", ar: "اتصل بي" } },
      ],
      skillsType: "",
      skillsItems: [
        { imgUrl: "assets/images/HTML5.png", title: "HTML5" },
        { imgUrl: "assets/images/css3.png", title: "CSS3" },
        { imgUrl: "assets/images/javascript.png", title: "JavaScript" },
        { imgUrl: "assets/images/Typescript.png", title: "TypeScript" },
        { imgUrl: "assets/images/JQuery.png", title: "jQuery" },
        { imgUrl: "assets/images/Bootstrap.png", title: "Bootstrap" },
        { imgUrl: "assets/images/nodejs.png", title: "Nodejs" },
        { imgUrl: "assets/images/React.png", title: "React" },
        { imgUrl: "assets/images/npm-logo.png", title: "NPM" },
        { imgUrl: "assets/images/wordpress.png", title: "WordPress" },
        { imgUrl: "assets/images/shopify.png", title: "Shopify" },
    
      ],
      toolsItems: [
        { imgUrl: "assets/images/Ae.png", title: "After Effects" },
        { imgUrl: "assets/images/Ai.png", title: "Illustrator" },
        { imgUrl: "assets/images/Dw.png", title: "Dreamweaver" },
        { imgUrl: "assets/images/Id.png", title: "InDesign" },
        { imgUrl: "assets/images/photoshop.png", title: "Photoshop" },
        { imgUrl: "assets/images/Premiere.png", title: "Premiere" },
        { imgUrl: "assets/images/Creative Cloud.png", title: "Creative Cloud" },
        { imgUrl: "assets/images/vscode.png", title: "VS Code" },
        { imgUrl: "assets/images/trello.png", title: "Trello" },
        { imgUrl: "assets/images/clickup-logo.png", title: "ClickUp" },
        { imgUrl: "assets/images/slack.png", title: "Slack" },
        { imgUrl: "assets/images/git.png", title: "Git (Github)" },
      ],
      experienceItems: [
        {
          date: "2015-2018",
          companyName: { en: "The Fountain of Praise", ar: "شركة فيسبوك" },
          jobTitle: { en: "Graphic Designer", ar: "مطوّر الويب المتكامل" },
          desc: {
            en: " Develop overall layout and production design for online engagements, advertisements, brochures, magazines, and corporate reports.",
            ar: "تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.",
          },
        },
        {
          date: "2015-2020",
          companyName: { en: "Present the Vision", ar: "شركة انفاتو" },
          jobTitle: {
            en: "Director of Photography / UX Designer",
            ar: "مطور UI/UX",
          },
          desc: {
            en: "Assists the film director by establishing the visual look of the movie. Create products that provide meaningful and relevant experiences to users.",
            ar: "تم تحويل تخطيطات Photoshop إلى صفحات ويب باستخدام HTML و CSS و JavaScript.",
          },
        },
        {
          date: "2017-2019",
          companyName: { en: "Los Angeles Film School", ar: "شركة جوجل" },
          jobTitle: { en: "Digital Filmmaking", ar: "مطور الواجهة الأمامية" },
          desc: {
            en: "build upon the foundations of film theory and apply it to an experiential learning environment with the support of your online peers.",
        ...
        },
        {
          date: "2020-Present",
          companyName: {
            en: "Visionary Artist Media Production",
            ar: "شركة جوجل",
          },
          jobTitle: {
      ...
      itemsPerPage: 7,
      filters: ["All", "Graphics", "Video", "Coding"],
      currentFilter: "All",
      ...
      allPortfolioItems: [
       /*  {
          ...
          imgUrl: "assets/images/work/mmhtt.jpg",
          title: { en: "Mama's Magic Hot Tea Mix", ar: "هنا عنوان المشروع 1" },
          date: { en: "August 2019", ar: "أبريل 2019" },
          desc: {
          ...
          screenshots: {
            img1: {
              url: "assets/images/work/mmhtt.jpg",
              caption: { en: "Mama's Magic Tea Mix", ar: "تسمية توضيحية 5" },
            },
          },
        },
        {
       ...
       */ {
        ...
        },
        {
          ...
          imgUrl: "assets/images/work/vampmain.jpg",
          title: { en: "Visionary Artist Media Production (Video)", ar: "هنا عنوان المشروع 13" },
          date: { en: "April 2020", ar: "أبريل 2020" },
          desc: {
            en: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
            ar: "هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق. إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع. ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً، دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.",
          },
          ...
          screenshots: {
            img1: {
              url: "assets/images/work/gig.mp4",
              caption: { en: "Editing", ar: "تسمية توضيحية 5" },
            },
            img2: {
              url: "assets/images/work/maggie.mp4",
              caption: { en: "MaggieMoo", ar: "تسمية توضيحية 4" },
            },
            img3: {
              url: "assets/images/work/dom.mp4",
              caption: { en: "Dom.Tx", ar: "تسمية توضيحية 3" },
            },
            /*img4: {
              url: "https://via.placeholder.com/300x225",
              caption: { en: "caption 2", ar: "تسمية توضيحية 2" },
        ...
        },
        {
          ...
          imgUrl: "assets/images/work/Coding.jpg",
          title: { en: "Visionary Artist Media Production (Coding)", ar: "هنا عنوان المشروع 14" },
          date: { en: "April 2022", ar: "أبريل 2021" },
          desc: {
            en: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
            ar: "هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق. إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع. ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً، دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.",
          },
          ...
          screenshots: {
            img1: {
                url: "assets/images/work/egr2.jpg",
                caption: { en: "EGR Fashion", ar: "تسمية توضيحية 4" },
              },
            img2: {
              url: "assets/images/work/egr1.jpg",
              caption: { en: "EGR Fashion", ar: "تسمية توضيحية 5" },
            },
            img3: {
              url: "assets/images/work/rp2.jpg",
              caption: { en: "RetroPunks", ar: "تسمية توضيحية 4" },
            },
            img4: {
              url: "assets/images/work/rp1.jpg",
              caption: { en: "RetroPunks", ar: "تسمية توضيحية 3" },
            },
            img5: {
              url: "assets/images/work/vamp2.jpg",
              caption: { en: "Visionary Artist Media Production", ar: "تسمية توضيحية 2" },
            },
            img6: {
              url: "assets/images/work/vamp1.jpg",
              caption: { en: "Visionary Artist Media Production", ar: "تسمية توضيحية 1" },
            },
          },
        },
        {
        ...
        },
        {
          ...
          imgUrl: "assets/images/work/tfop/1.jpg",
          title: { en: "The Fountain of Praise (Youth Ministry)", ar: "هنا عنوان المشروع 16" },
          date: { en: "Jan 2015", ar: "أبريل 2021" },
          desc: {
            en: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
            ar: "هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق. إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع. ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً، دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.",
          },
          ...
          screenshots: {
            img1: {
              url: "assets/images/work/tfop/1.jpg",
              caption: { en: "College Tours 1", ar: "تسمية توضيحية 5" },
            },
            img2: {
              url: "assets/images/work/tfop/2.jpg",
              caption: { en: "College Tours 2", ar: "تسمية توضيحية 4" },
            },
            img3: {
              url: "assets/images/work/tfop/3.jpg",
              caption: { en: "Teen Rock Bible Study", ar: "تسمية توضيحية 3" },
            },
            img4: {
              url: "assets/images/work/tfop/4.jpg",
              caption: { en: "Spring Rock Out", ar: "تسمية توضيحية 2" },
            },
            img5: {
              url: "assets/images/work/tfop/5.jpg",
              caption: { en: "Rock Your Gift", ar: "تسمية توضيحية 1" },
            },
          },
        },
        {
        ...
        },
        {
          ...
          title: { en: "The Fountain of Praise", ar: "هنا عنوان المشروع 18" },
          date: { en: "April 2021", ar: "أبريل 2021" },
          desc: {
            en: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
            ar: "هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق. إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع. ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً، دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.",
        ...
        document.addEventListener("keyup", (n) => {
          if (e.classList.contains("menu-open")) {
            const a = [
              ...
              (e) =>
                "hidden" !==
                window.getComputedStyle(e).getPropertyValue("visibility")
            );
            (t = a[0]),
              (i = a[a.length - 1]),
              "Tab" === n.code
        ...
        "" === t.value
          ? ((n.name.required = !0),
            this.setNotify({
              id: "nameRequired",
              className: "danger",
              msg: t.closest(".control").querySelector(".errors-msgs .required")
                .value,
            }))
          : ((n.name.required = !1), this.dismissNotify("nameRequired")),
          t.value.length > 0 && t.value.length < t.getAttribute("minlength")
            ? ((n.name.minLength = !0),
              this.setNotify({
                id: "nameMinLength",
                className: "danger",
            ...
            : ((n.name.minLength = !1), this.dismissNotify("nameMinLength")),
          Object.keys(n.name).some((e) => !0 === n.name[e])
            ? (t.classList.remove("valid"), t.classList.add("invalid"))
            : (t.classList.remove("invalid"), t.classList.add("valid")),
          "" === i.value
            ? ((n.email.required = !0),
              this.setNotify({
                id: "emailRequired",
            ...
            : ((n.email.required = !1), this.dismissNotify("emailRequired")),
          i.value.length > 0 &&
          !/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(
            ...
            : ((n.email.invalid = !1), this.dismissNotify("emailInvalid")),
          ...
          !/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im.test(
            ...
            : ((n.phone.invalid = !1), this.dismissNotify("phoneInvalid")),
          Object.keys(n.phone).some((e) => !0 === n.phone[e])
            ? (s.classList.remove("valid"), s.classList.add("invalid"))
            : (s.classList.remove("invalid"), s.classList.add("valid")),
          "" === o.value
          ...
          Object.keys(n.message).some((e) => !0 === n.message[e])
            ? (o.classList.remove("valid"), o.classList.add("invalid"))
            : (o.classList.remove("invalid"), o.classList.add("valid")),
          !Object.values(n).some((e) => Object.values(e).some(Boolean)) &&
    ...
    computed: {
      ...
      copyrightDate() {
        ...
        return 0 === e
          ...
          : `${this.copyrightStartDate} - ${this.copyrightStartDate + e}`;
      },
    },
    directives: {
      clone: {
